...
#define FONT_SPECIAL_NAME Marlin_symbols
  ...
  #elif ENABLED(DISPLAY_CHARSET_tc_TW)
...
//laser
  ...
  u8g.drawBitmapP(lasertpos + 3,8, LASER_BYTEWIDTH, LASER_HEIGHT, laseroff_bmp);
  else
  u8g.drawBitmapP(lasertpos + 3,8,LASER_BYTEWIDTH,LASER_HEIGHT, (blink % 2) && lpwper ? laseron0_bmp : laseron1_bmp);
  

  
  u8g.setPrintPos(lasertpos,28);
