...
//M902: Laser Driver Power OFF
 ...
 >若要使用自己的configuration.h (也要是Marlin 1.1.0-RC8的 沒測試過其他版本可不可以)
 >只要在裡面加上 #define LASER_CONTROL 以及語言改為 tw 既可)
 >#define LCD_LANGUAGE tw //這一行en改tw



Origin Marlin:1.1.0-RC8 [https://github.com/MarlinFirmware/Marlin]
*/
...
#define STRING_CONFIG_H_AUTHOR "(hpo14, Prusa I3)" // Who made the changes.
...
//    kana, kana_utf8, nl, pl, pt, pt_utf8, pt-br, pt-br_utf8, ru, tr, uk, test, tw
//
