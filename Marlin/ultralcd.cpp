...
#if ENABLED(DOGLCD)
void lcd_verr() {
  u8g.drawStr(5,13,"\x4d\x61\x72\x6c\x69\x6e\x20\x76\x2e\x31\x2e\x31\x2e\x30\x2d\x52\x43\x38");
  u8g.drawStr(5,23,"\x76\x65\x72\x2e\x30\x30\x31\x20\x28\x31\x30\x35\x31\x32\x30\x36\x29");
